...
.. code-block:: bash
    ...
    $ my-fastapi-project --help
    Usage: my-fastapi-project [OPTIONS] COMMAND [ARGS]...

      My-fastapi-project CLI root.
    ...
    Commands:
      serve  my-fastapi-project CLI serve command.
    $ my-fastapi-project serve --help
    Usage: my-fastapi-project serve [OPTIONS]
...
.. code-block:: bash
    ...
    $ make image
    $ podman run -dit --name my-fastapi-project -p 8000:8000 my-fastapi-project:$(cat TAG)
    f41e5fa7ffd512aea8f1aad1c12157bf1e66f961aeb707f51993e9ac343f7a4b
    $ podman ps
    CONTAINER ID  IMAGE                                 COMMAND               CREATED        STATUS            PORTS                   NAMES
    f41e5fa7ffd5  localhost/my-fastapi-project:0.1.0  /usr/bin/fastapi ...  2 seconds ago  Up 3 seconds ago  0.0.0.0:8000->8000/tcp  my-fastapi-project
    $ curl localhost:8000/api/ready
    {"status":"ok"}
...
You can implement your own web routes logic straight away in ``my_fastapi_project.controllers`` submodule. For more information please see `FastAPI documentation <https://fastapi.tiangolo.com/tutorial/>`__.
...
.. code-block:: bash
    ...
    Usage:
      ...
      clean-image      Clean my-fastapi-project image
      install          Install my-fastapi-project with poetry
      metrics          Run my-fastapi-project metrics checks
      unit-test        Run my-fastapi-project unit tests
      integration-test  Run my-fastapi-project integration tests
      docs             Build my-fastapi-project documentation
...
* RedisClient ``my_fastapi_project.app.utils.redis``
* AiohttpClient ``my_fastapi_project.app.utils.aiohttp_client``
...
.. code-block:: python
    ...
    from my_fastapi_project.app.utils import RedisClient
...
.. literalinclude:: ../my_fastapi_project/app/exceptions/http.py
    :language: python
...
All application configuration is available in ``my_fastapi_project.config`` submodule.
...
.. literalinclude:: ../my_fastapi_project/config/gunicorn.py
    :language: python

Routes
~~~~~~

Endpoints are defined in ``my_fastapi_project.app.router`` submodule. Just simply import your controller and include it to FastAPI router:

.. literalinclude:: ../my_fastapi_project/app/router.py
    :language: python
